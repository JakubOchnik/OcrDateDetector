...
def test_token_parser():
    expect_parser_output("abcd_{date}{name}", [Token(TokenType.TEXT, "abcd_"), Token(TokenType.DATE), Token(TokenType.FILE_NAME)])
...
def test_get_file_name():
    assert get_file_name("01-01-1991", "test", [Token(TokenType.TEXT, "abc"), Token(TokenType.DATE), Token(TokenType.FILE_NAME)]) == "abc01-01-1991test"
